...
if __name__ == '__main__':
    ...
    dt, preintegration_steps, acc, gyr = preintegration.build_steps(measurements.accelerometer, measurements.gyroscope,
                                                                    measurements.timestamps_camera,
                                                                    measurements.timestamps_IMU,
                                                                    imu_dts)
    ...
    factor_graph.push_back(
        gtsam.PriorFactorPose3(symbol('x', preintegration_steps[-1]), params.initial_state.pose(),
                               params.initial_pose_covariance))
    factor_graph.push_back(
        gtsam.PriorFactorVector(symbol('v', preintegration_steps[-1]), params.initial_state.velocity(),
